        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container px-2">
                ...
                <a href="{{ url('/') }}" class="navbar-brand">
                    <img style="width: 50px" src="{{asset('https://thumbs.dreamstime.com/b/la-russie-moscou-avril-ic%C3%B4ne-de-cam%C3%A9ra-logotype-d-instagram-sur-le-fond-blanc-demande-libre-partager-gratuite-des-photos-et-vid-146191650.jpg')}}" alt="InstaClone Logo" >
                </a>
